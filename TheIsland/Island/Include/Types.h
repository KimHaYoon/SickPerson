...
// Tex Normal Vertex
typedef struct GAME_DLL _tagVertexTexNormal
{
	Vector3	vPos;
	Vector3	vNormal;
	Vector2	vUV;
...
// Bump Vertex
typedef struct GAME_DLL _tagVertexBump
{
	Vector3	vPos;
	Vector3	vNormal;
	Vector2	vUV;
...
// Bump Vertex
typedef struct GAME_DLL _tagVertexAnim
{
	Vector3	vPos;
	Vector3	vNormal;
	Vector2	vUV;
...
// Bump Vertex
typedef struct GAME_DLL _tagVertexBumpAnim
{
	Vector3	vPos;
	Vector3	vNormal;
	Vector2	vUV;
...
// Rect Info
typedef struct GAME_DLL _tagRectInfo
{
	float	l;
	float	t;
	float	r;
...
typedef struct GAME_DLL _tagObb2DInfo
{
	Vector3	vCenter;
	Vector3	vAxisX;
	Vector3	vAxisY;
...
typedef struct GAME_DLL _tagAABB
{
	Vector3	vMin;
	Vector3	vMax;
}AABB, *PAABB;
...
typedef struct GAME_DLL _tagRay
{
	Vector3	vPos;
	Vector3	vDir;
	float	fDist;
...
typedef struct GAME_DLL _tagSphere
{
	Vector3	vCenter;
	float	fRadius;
}SPHERE, *PSPHERE;

typedef struct GAME_DLL _tagParticleCBuffer
{
	Vector3		vCamAxisX;
	float		fEmpty1;
	Vector3		vCamAxisY;
...
typedef struct GAME_DLL _tagLandScapeCBuffer
{
	int		iDetailLevel;
	int		iSplatCount;
	Vector2	vEmpty;
...
typedef struct GAME_DLL _tagMultiTextureCBuffer
{
	Vector2	vAreaStart;
	Vector2	vAreaEnd;
